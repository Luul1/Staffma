  ...
  const handleAddEmployee = async (e) => {
    ...
    try {
      ...
      const employeeData = {
        ...
        employmentEndDate: newEmployee.employmentEndDate,
        probationEndDate: newEmployee.probationEndDate,
        bankDetails: {
          bankName: newEmployee.bankDetails.bankName,
          branchName: newEmployee.bankDetails.branchName,
          ...
          <form onSubmit={handleAddEmployee} style={styles.form}>
            <div style={styles.formGrid}>
              ...
              {(newEmployee.employmentType === 'contract' || 
                newEmployee.employmentType === 'attachment') && (
                <div style={styles.formGroup}>
                  <label style={styles.label}>End Date</label>
                  <input
                    style={styles.input}
                    type="date"
                    value={newEmployee.employmentEndDate}
                    onChange={(e) => setNewEmployee({
                      ...newEmployee,
              ...
              {newEmployee.employmentType === 'probation' && (
                <div style={styles.formGroup}>
                  <label style={styles.label}>Probation End Date</label>
                  <input
                    style={styles.input}
                    type="date"
                    value={newEmployee.probationEndDate}
                    onChange={(e) => setNewEmployee({
                      ...newEmployee,
                ...
                <div style={styles.formGrid}>
                  ...
                  <div style={styles.formGroup}>
                    ...
                    <input
                      style={styles.input}
                      type="text"
                      value={newEmployee.bankDetails.branchName}
                      onChange={(e) => setNewEmployee({
                        ...newEmployee,
                        bankDetails: {
                          ...newEmployee.bankDetails,
        ...
        <table style={styles.table}>
          <thead>
            <tr>
              ...
              <th style={styles.tableHeader}>Employment Type</th>
